...
<aside class="app-sidebar" id="appSidebar">
    ...
    <nav class="sidebar-nav">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link<?= $is('/tasks/') ?>" href="<?= e(url('modules/tasks/index.php')) ?>">
                    <i class="bi bi-list-check"></i> Field Tasks
                </a>
            </li>
            <?php endif; ?>
            ...
            <li class="nav-item">
                <a class="nav-link<?= $is('/inventory/') ?>" href="<?= e(url('modules/inventory/items.php')) ?>">
                    <i class="bi bi-box-seam"></i> Inventory
                </a>
            </li>
            <?php endif; ?>

            <?php if (can('asset.view')): ?>
            <li class="nav-item">
                <a class="nav-link<?= $is('/assets/') ?>" href="<?= e(url('modules/assets/index.php')) ?>">
                    <i class="bi bi-truck-front"></i> Vehicles &amp; Machinery
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link<?= $is('/fuel/') ?>" href="<?= e(url('modules/fuel/purchases.php')) ?>">
